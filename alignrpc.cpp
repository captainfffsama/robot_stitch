...
int AlignRpc::getHMatrix(const std::string& img1base64,const std::string& img2base64,cv::Mat& H)
{
    int flag=-1;
    ...
    void mat2QImage(const cv::Mat& mat, QImage& dstImg)
    {
            ...
            case CV_8UC1:
        {
            ...
            case CV_8UC3:{
                ...
                dstImg=QImage(pSrc, mat.cols, mat.rows, mat.step, QImage::Format_RGB888).rgbSwapped();
                break;
            }
            case CV_8UC4:
                {
                ...
                const uchar *pSrc = (const uchar*)mat.data;
                // Create QImage with same dimensions as input Mat
                dstImg=QImage(pSrc, mat.cols, mat.rows, mat.step, QImage::Format_ARGB32).copy();
                break;
                }
            default:
                break;
